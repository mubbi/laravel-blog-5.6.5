            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="title" name="title" placeholder="Write something beautiful today...">
                    </div>
                    <div class="form-group">
                        <label for="excerpt">Excerpt/Summary <span class="required">*</span></label>
                        <textarea name="excerpt" id="excerpt" class="form-control" rows="3" maxlength="280" placeholder="summary of my beautiful words..."></textarea>
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="user_id" name="user_id">
                            ...
                            <option value="{{ $author->id }}" @if(Auth::user()->id == $author->id) selected @endif>{{ $author->name }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group">
