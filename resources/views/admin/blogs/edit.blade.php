                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="user_id" name="user_id" required>
                            ...
                            <option value="{{ $author->id }}" @if($blog->user_id == $author->id) selected @endif>{{ $author->name }} ({{ $author->email }})</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group">
                        ...
                        <select class="form-control" id="is_active" name="is_active" required>
                            <option value="1" @if($blog->is_active == 1) selected @endif>Yes</option>
                            <option value="0" @if($blog->is_active == 0) selected @endif>No</option>
                        </select>
                    </div>
                    <div class="form-group">
                        ...
                        <select class="form-control" id="allow_comments" name="allow_comments" required>
                            <option value="1" @if($blog->allow_comments == 1) selected @endif>Yes</option>
                            <option value="0" @if($blog->allow_comments == 0) selected @endif>No</option>
                        </select>
                    </div>
                </div>
                <div class="col-md-12">
