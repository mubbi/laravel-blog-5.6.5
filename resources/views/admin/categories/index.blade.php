...
@section('content')
<div class="card">
    <div class="card-header">Categories - View All <a href="{{ route('categories.create') }}" class="btn btn-primary float-right btn-sm mr-2"><i class="fas fa-plus"></i> Add</a></div>
...
$(document).ready(function() {
    $('#dataTable').DataTable({
        ...
        "language": {
            ...
            "emptyTable": "No Categories Found, Create the first category.",
            "oPaginate": {
        ...
        serverSide: true,
        ajax: '{!! route('categories.ajaxData') !!}',
        columns: [
        ...
        buttons: [
            {
                ...
                action: function ( e, dt, node, config ) {
                    if (confirm('Are you sure?')) {
                        ...
                        window.location.href = '{{ route("categories.bulkDelete") }}?ids=' + selectedIds;
                    }
                },
