...
@section('content')
<div class="card">
    <div class="card-header">Users - View All <a href="{{ route('users.create') }}" class="btn btn-primary float-right btn-sm mr-2"><i class="fas fa-plus"></i> Add</a></div>
...
$(document).ready(function() {
    $('#dataTable').DataTable({
        ...
        "language": {
            ...
            "emptyTable": "No Users Found, Create the first blog.",
            "oPaginate": {
        ...
        buttons: [
            {
                ...
                action: function ( e, dt, node, config ) {
                    if (confirm('Are you sure?')) {
                        ...
                        window.location.href = '{{ route("users.bulkDelete") }}?ids=' + selectedIds;
                    }
                },
